            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-12 w-full justify-start gap-2 px-2">
                <Avatar className="h-8 w-8">
                  <AvatarImage src="https://picsum.photos/seed/lab-tech/200/200" alt="Lab Tech" data-ai-hint="person face" />
                  <AvatarFallback>LT</AvatarFallback>
                </Avatar>
                <div className="text-left">
                  <p className="text-sm font-medium">Lab Tech</p>
                  <p className="text-xs text-muted-foreground">lab.tech@medibridge.app</p>
                </div>
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent className="w-56 mb-2" align="end" forceMount>
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  <p className="text-sm font-medium leading-none">Lab Tech</p>
                  <p className="text-xs leading-none text-muted-foreground">
                    lab.tech@medibridge.app
                  </p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
