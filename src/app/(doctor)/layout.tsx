            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-12 w-full justify-start gap-2 px-2">
                <Avatar className="h-8 w-8">
                  <AvatarImage src="https://picsum.photos/seed/doc1/200/200" alt="Dr. Carter" data-ai-hint="doctor person" />
                  <AvatarFallback>EC</AvatarFallback>
                </Avatar>
                <div className="text-left">
                  <p className="text-sm font-medium">Dr. Emily Carter</p>
                  <p className="text-xs text-muted-foreground">emily.carter@medibridge.app</p>
                </div>
              </Button>
            </DropdownMenuTrigger>
